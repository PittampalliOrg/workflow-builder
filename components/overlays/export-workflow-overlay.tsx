	...
	return (
		...
		>
			<div className="flex items-center gap-2 text-muted-foreground">
				...
				<p className="text-sm">
					Export your workflow as a Dapr-compatible bundle that you can run
					outside the builder.
				</p>
			</div>

			<p className="mt-4 text-muted-foreground text-sm">
				This will generate a project bundle containing your workflow definition,
				action-level code files, and runner scripts for orchestrator APIs. Once
				exported, you can execute or adapt the workflow in your own Dapr
				environment.
			</p>
