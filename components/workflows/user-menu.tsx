...
import { Key, LogOut, Moon, Plug, Server, Settings, Sun } from "lucide-react";
		...
		<DropdownMenu>
			...
			<DropdownMenuContent align="end" className="w-56">
				...
				<DropdownMenuSub>
					...
					<DropdownMenuSubContent>
						<DropdownMenuItem
							onClick={() => router.push("/settings/oauth-apps")}
						>
							<Settings className="size-4" />
							<span>OAuth Apps</span>
						</DropdownMenuItem>
						<DropdownMenuItem onClick={() => router.push("/settings/mcp")}>
