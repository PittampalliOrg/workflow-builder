...
P3. Decompose quarantine adapters — benchmark-service.ts (6,907 lines), evaluation-service.ts (3,702), and benchmark-trace-bundle.ts (1,394) were moved wholesale behind one port; the former mlflow-lifecycle.ts adapter has since been retired. Also review the ~10 "pending deeper split" transport seams flagged in docs/workflow-orchestrator-postgres-inventory.md (~lines 277, 513, 539, 636, 1338, and 1471-1485 roadmap).
