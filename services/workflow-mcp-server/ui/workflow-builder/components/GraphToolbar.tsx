...
interface Props {
	...
	onExecutionStatus?: (status: ExecutionProgress | null) => void;
	onShowResults?: () => void;
	onExecutionStarted?: (instanceId: string) => void;
}
...
export function GraphToolbar({
	...
	const [executionInstanceId, setExecutionInstanceId] = useState<string | null>(
		null,
	);
	...
	const startPolling = useCallback(
		...
		[api, stopPolling, onExecutionStatus],
	);
