...
<div class="flex h-full flex-col">
	<header class="flex h-12 items-center justify-between border-b border-border px-6">
		<div class="flex min-w-0 items-center gap-3">
			<Button variant="ghost" size="icon" href="/admin/instances">
				<ArrowLeft size={15} />
			</Button>
			<div class="min-w-0">
	...
	<div class="flex-1 overflow-auto p-6">
		<div class="mb-4 flex items-center gap-2 text-sm text-muted-foreground">
			<a class="hover:text-foreground" href="/admin/instances">Workflow executions</a>
			<span>/</span>
		...
		<Tabs bind:value={activeTab} class="mt-5 space-y-4">
			...
			<TabsContent value="relationships">
									...
									<TableRow class="hover:bg-muted/30">
										<TableCell class="px-4 py-3 font-mono text-xs">
											<a
												...
												href={`/admin/instances/${encodeURIComponent(relationship.instanceId)}`}
											>
				...
				<Button class="mt-3" variant="outline" href="/admin/instances">
