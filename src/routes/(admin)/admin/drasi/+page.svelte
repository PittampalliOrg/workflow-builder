...
<div class="@container flex h-full min-w-0 flex-col overflow-hidden">
	...
	<div class="overflow-x-auto border-b px-5 py-2 @max-md:px-3">
		<div
			...
			class="inline-flex min-w-max items-center gap-1 rounded-lg bg-muted p-[3px] text-muted-foreground @max-md:grid @max-md:w-full @max-md:min-w-0 @max-md:grid-cols-2 @max-md:items-stretch"
		>
			<button
				...
				class="inline-flex h-7 items-center gap-1.5 rounded-md px-2.5 text-sm font-medium transition-colors @max-md:h-auto @max-md:min-h-8 @max-md:w-full @max-md:justify-center @max-md:px-1.5 @max-md:py-1 @max-md:text-xs @max-md:leading-tight {tab ===
				'system'
					? 'bg-background text-foreground shadow-sm'
					: 'hover:text-foreground'}"
			>
				<Waypoints class="size-3.5 shrink-0" />
				System
			</button>
			<button
				...
				class="inline-flex h-7 items-center gap-1.5 rounded-md px-2.5 text-sm font-medium transition-colors {tab ===
				'queries'
					? 'bg-background text-foreground shadow-sm'
					: 'hover:text-foreground'}"
			>
				...
				Queries
				<span class="ml-1 text-[0.65rem] text-muted-foreground">{DRASI_COUNTS.queries}</span>
			</button>
			<button
			...
			>
				...
				Data sources
				<span class="ml-1 text-[0.65rem] text-muted-foreground @max-md:ml-0">
