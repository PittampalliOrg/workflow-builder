...
<div class="flex h-full flex-col overflow-hidden">
	<header class="border-b px-5 py-3">
		<div class="flex flex-wrap items-center justify-between gap-3">
			<div class="flex min-w-0 flex-wrap items-center gap-2">
				<Radar class="size-5 text-muted-foreground" />
	...
	<Tooltip.Provider>
		<div class="flex flex-wrap items-center gap-x-2 gap-y-1.5 border-b px-5 py-2">
			<span
			...
			<Tooltip.Root>
				<Tooltip.Trigger
					class="inline-flex h-5 cursor-help items-center gap-1.5 rounded-md border px-1.5 text-[0.65rem] font-medium text-muted-foreground"
				>
	...
	<div class="overflow-x-auto border-b px-5 py-2">
		...
		>
			...
			>
				...
				Data sources
				<span class="ml-1 text-[0.65rem] text-muted-foreground">{DRASI_COUNTS.sources}</span>
			</button>
			<button
