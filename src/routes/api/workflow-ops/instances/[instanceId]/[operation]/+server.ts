...
import { runWorkflowOperation } from '$lib/server/workflow-ops';
...
export const POST: RequestHandler = async ({ params, request, locals }) => {
	...
	const result = await runWorkflowOperation(params.instanceId, params.operation, {
		...
		eventData: parseJsonInput(body.eventDataJson),
