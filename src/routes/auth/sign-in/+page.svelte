...
<div class="flex min-h-screen items-center justify-center bg-background">
	<div class="w-full max-w-sm space-y-6 rounded-xl border border-border bg-card p-8 shadow-lg">
		...
		<div class="flex flex-col gap-2">
			<Button variant="outline" class="h-10 w-full" onclick={signInWithGitHub}>
			...
			<Button variant="outline" class="h-10 w-full" onclick={signInWithGoogle}>
		...
		<form onsubmit={handleSubmit} class="space-y-4">
			...
			<Button class="h-10 w-full" type="submit" disabled={isLoading || !email || !password}>
				{#if isLoading}
