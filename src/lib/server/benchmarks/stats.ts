...
// Phase J — cohort pivot helper lives in $lib/benchmarks/cohort.ts (no
// server deps) so the CohortPivot Svelte component can use it client-side.
// Re-exported here for callers already importing from stats.ts.
export {
	COHORT_DIMENSIONS,
	COHORT_MEASURES,
	pivot,
...
import type { CohortRow } from "$lib/benchmarks/cohort";
