...
const CONTROL_TARGET: HandleRule = {
  dataType: "control",
  accepts: ["control", "branch", "any"],
};
const CONTROL_SOURCE: HandleRule = {
  dataType: "control",
  accepts: ["control", "any"],
};
...
/**
 * Static handle rules for all workflow-builder canvas node types.
...
export const NODE_HANDLE_RULES: Record<WorkflowNodeType, NodeHandleConfig> = {
  ...
  agent: { targets: [CONTROL_TARGET], sources: [CONTROL_SOURCE] },
