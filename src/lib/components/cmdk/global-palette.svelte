<script lang="ts">
	...
	const navItems: Array<{
		...
		{ label: 'Admin: GitOps', path: '/admin/gitops', icon: GitBranch, keywords: 'admin promoter deployments release pins kargo freight pipeline images skaffold ryzen dev outer loop overview' },
