...
<SelectPortal {...portalProps}>
	...
	>
		...
		<SelectPrimitive.Viewport
			class={cn(
				"w-full min-w-(--bits-select-anchor-width) scroll-my-1 bg-popover p-1 text-popover-foreground"
			)}
		>
			{@render children?.()}
		</SelectPrimitive.Viewport>
