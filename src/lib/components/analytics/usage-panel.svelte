<script lang="ts">
	/** Token-usage panel — extracted from the old /usage page so the merged
	 *  "Cost & Usage" page can host it alongside the cost panel. Self-contained:
	 *  fetches /api/v1/usage, month picker + CSV export, totals + daily chart +
	 *  by-agent table. */
