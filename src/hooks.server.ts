...
export const PREVIEW_CONTROL_BROKER_ROUTES = Object.freeze([
  ...
  ["POST", "/api/internal/preview-control/development-build"],
	["POST", "/api/internal/preview-control/development"],
  ...
  ["POST", "/api/internal/preview-control/environment/workflow-diagnostics"],
  ["POST", "/api/internal/preview-control/environment/workspace-source"],
