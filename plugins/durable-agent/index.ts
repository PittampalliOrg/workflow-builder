  ...
  actions: [
    {
      ...
      outputFields: [
        ...
        { field: "staticToolCalls", description: "Tool calls that were not executed" },
        { field: "loopStopReason", description: "Loop stop reason from runtime policy" },
        { field: "loopStopCondition", description: "Matched loop condition payload" },
        { field: "requiresApproval", description: "Approval details if halted for approval" },
        { field: "usageTotals", description: "Aggregated token usage across loop steps" },
